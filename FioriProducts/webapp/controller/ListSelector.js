sap.ui.define([
	...
	return BaseObject.extend("products.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias products.model.ListSelector
		 */
		 ...
		 * @return {products.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
