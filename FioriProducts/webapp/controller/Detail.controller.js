...
sap.ui.define([
	...
	return BaseController.extend("products.controller.Detail", {
...
this.getRouter().getRoute("object").attachPatternMatched(
...
sObjectName = oObject.PRODUCT_NAME,
...
// Binding the view will set it to not busy - so the
// view is always busy if it is not bound
oViewModel.setProperty("/busy", true);
