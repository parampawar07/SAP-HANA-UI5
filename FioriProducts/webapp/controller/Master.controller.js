/*global history */
sap.ui.define([
	"products/controller/BaseController",
...
this.getRouter().attachBypassed(this.onBypassed, this);
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("PRODUCT_NAME", FilterOperator.Contains, sQuery)];
			} else {
		...
		onGroup: function(oEvent) {
			...
			if (sKey === "PRICE") {
				...
				this.getModel("masterView").setProperty("/sortBy", "PRICE");
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("products.view.ViewSettingsDialog", this);
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("PRODUCT");
